...
public class ActivityCountCompressibilityFactor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_count_compressibility_factor);
        ...
        try{
            ...
            if(cursor.moveToFirst()){
                ...
                CheckBox favorite = (CheckBox)findViewById(R.id.favotite_compressfactor);
